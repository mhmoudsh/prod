  <header id="header" class="header fixed-top">
    ...
    <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto active" href="index.php">main</a></li>
       ...
       <?php  if (!isLoggedIn()) {
               ...
               echo '
                     ...
                     <li><a class="nav-link scrollto" href="category_table.php">categories </a></li>
                     <li><a class="nav-link scrollto" href="subcattable.php">sub categories </a></li>
